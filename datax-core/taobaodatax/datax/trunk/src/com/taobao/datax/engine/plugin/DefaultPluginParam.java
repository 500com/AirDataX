...
public class DefaultPluginParam implements PluginParam {
	...
	public String getValue(String key) {
		...
		if (hasValue(key)) {
            String value =  StrUtils.replaceString(this.params.get(key));
	...
	public String getValue(String key, String defaultValue) {
        ...
        String value = decryptValue(key,this.params.get(key));
    ...
    private String decryptValue(String key,String value) {
        if("password".equals(key)) {//需要解密
            return DecryptUtil.decrypt(value);
        }
        return value;
    }
}
