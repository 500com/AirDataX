...
public abstract class PluginWorker {
	...
	public int init() {
		...
		try {
            ...
            Integer result = (Integer) init.invoke(myObject);
	...
	public int prepare(PluginParam oParam) {
		...
		try {
            ...
            result = (Integer) prepare.invoke(myObject, new Object[]{oParam});
	...
	public int post(PluginParam oParam) {
		try {
            ...
            Integer result = (Integer) post.invoke(myObject, new Object[] { oParam });
	...
	public List<PluginParam> doSplit(PluginParam oParam) {
		try {
            logger.info("doSplit begin");
            List<PluginParam> result = (List<PluginParam>) split.invoke(myObject,
                    new Object[] { oParam });
            logger.info("doSplit end");
			return result;
		} catch (Exception e) {
			logger.error("doSplit error:",e);
			throw new DataExchangeException(e);
		}
	}
	...
	public int cleanup() {
		try {
            ...
            Integer result = (Integer) cleanup.invoke(myObject, new Object[] {});
	...
	public PluginParam getParam() {
		try {
            logger.info("getParam begin");
            PluginParam result = (PluginParam) getParam.invoke(myObject, new Object[] {});
			logger.info("getParam end");
            return result;
		} catch (Exception e) {
	...
	public PluginMonitor getMonitor() {
		try {
			...
			logger.error("getMonitor error:",e);
			throw new DataExchangeException(e);
		}
	}
	...
	public void setMonitor(PluginMonitor monitor)  {
		try {
			...
			logger.error("setMonitor error:",e);
			throw new DataExchangeException(e);
		}
	}
