...
public final class EnvUtils {
    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(EnvUtils.class);

    static {
        logger.info("load lib begin");
        try {
            System.load(Constants.DATAX_LOCATION + "/common/libcommon.so");

        }catch (Exception ignore) {
            logger.info("load lib error:",ignore);
        }
