 ...
 * 
 * */
public class ReaderWorker extends PluginWorker implements Callable<PluginWorkerResult> {
    ...
    public PluginWorkerResult call() throws Exception {
        ...
        try {
            ...
            iRetcode = (Integer) connect.invoke(myObject,
                    new Object[] {});
            if (iRetcode != 0) {
                result.errorMsg("Reader connect to DB failed .");
                logger.error(result.msg);
                //System.exit(ExitStatus.FAILED.value());
                return result;
            }
            ...
            if (iRetcode != 0) {
                result.errorMsg("Reader startRead failed .");
                logger.error(result.msg);
                //System.exit(ExitStatus.FAILED.value());
                return result;
            }
            ...
            try {
                ...
                if (iRetcode != 0) {
                    logger.warn("Reader finish loading failed ");
                }
